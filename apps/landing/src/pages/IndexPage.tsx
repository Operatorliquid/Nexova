...
const tN = [
  {
    slug: 'basic',
    name: 'Plan Inicial',
    description: 'Ideal para comenzar con analitica y gestion en tiempo real.',
    price: '$0',
    billing: 'Por mes / acceso gratuito',
  ...
  },
  {
    ...
    description: 'Para equipos que necesitan automatizacion y precision con IA.',
    price: '$129',
    billing: 'Por mes / facturacion mensual',
    checkoutUrl: '/checkout/?plan=standard',
    featured: !0,
    iconColor: 'text-yellow-500',
    features: [
      'Todo lo del Plan Inicial',
      'Analitica potenciada por IA',
  ...
  },
  {
    slug: 'pro',
    name: 'Plan Empresa',
    description: 'Para operaciones de alto volumen con soporte dedicado.',
    price: '$199',
    billing: 'Por mes / facturacion mensual',
    ...
    features: [
      ...
      'Usuarios y permisos por equipo',
      'Automatizacion avanzada por API',
        ...
        f.jsxs('div', {
          ...
          children: [
            f.jsxs('div', {
              ...
              children: [
                f.jsx(rN, {
                  text: 'Elegi el plan ideal para tu negocio',
                  as: 'h2',
                  className: 'text-2xl md:text-3xl font-medium text-foreground mb-3',
                }),
                f.jsx('p', {
                  ...
                  children:
                    'Desde seguimiento en tiempo real hasta analitica con IA, nuestros planes se adaptan al ritmo de crecimiento de tu equipo.',
                }),
              ],
            }),
            f.jsx('div', {
